...
\begin{itemize}
    ...
    \item \textbf{Tranche Lit}: $\gamma = 0.5$, rebalanced daily across 21 tranches ($1/21$th of the portfolio book per day).
    \item \textbf{Tranche SOR/Dark Pool}: $\gamma_{\text{eff}} = 0.12$, modeling a 40\% dark pool crossing rate at zero market impact.
\end{itemize}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{results/figures/equity_curve_general_full_horizon_2012-2026.png}
    \caption{Volatility-Weighted Momentum Strategy: Full Horizon General Portfolio Returns (2012--2026)}
    \label{fig:pnl_general}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{results/figures/equity_curve_hedging_full_horizon_2012-2026.png}
    \caption{Futures Trend-Hedging Impact Comparison: Full Horizon Performance (2012--2026)}
    \label{fig:pnl_hedging}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{results/figures/quantile_comparison.png}
    \caption{Quantile Selection Sensitivity Sweep: Cumulative Returns for Top 1\%, 3\%, 5\%, 10\%, and 20\% Thresholds}
    \label{fig:quantile_selection}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{results/figures/capacity_decay.png}
    \caption{Slippage Capacity Decay Curves: Net Sharpe Ratio as a Function of AUM across Routing Regimes}
    \label{fig:capacity_decay}
\end{figure}
